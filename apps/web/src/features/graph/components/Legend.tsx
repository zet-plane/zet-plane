    ...
    <div className="absolute right-3 top-3 z-10 rounded-md border border-border bg-background text-xs shadow-sm">
      ...
      {open && (
        <div className="space-y-2 border-t border-border p-2">
          ...
          <Row
            swatch={<span className="inline-block h-3 w-6 border-y-2 border-foreground" />}
            label="Scaffold (solid border)"
          />
          <Row
            swatch={<span className="inline-block h-3 w-6 border-y-2 border-dashed border-foreground" />}
